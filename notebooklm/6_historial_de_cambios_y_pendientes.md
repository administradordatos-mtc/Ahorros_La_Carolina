...
### A. Actualización y Refactorización (23 de Junio de 2026)
...
### B. Consolidación y Orientación a Iniciativas (22 de Junio de 2026)
...
### C. UX, Seguridad y Rendimiento (17 de Junio de 2026)
...
1. **Exportación de Datos**:
   * Implementar botón de descarga de informes a formato CSV/Excel directamente desde el panel de ejecución mensual (`execution.html`).
   * Razón: Permite a los auditores externos y al área financiera consolidar informes fuera del sistema.
2. **Alertas de Desviación Presupuestal**:
...
1. **Feedback Visual Completo (Spinners)**:
   * Replicar el componente de spinner de carga ya implementado en la vista de ejecución mensual en el resto de páginas (`index.html`, `initiatives.html`, `kpis.html`).
   * Razón: Mejora la percepción de velocidad en conexiones móviles o de red lenta mientras Supabase establece la sesión de usuario.
